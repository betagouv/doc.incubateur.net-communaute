...
Tchap est la messagerie instantanée du secteur public. Elle permet d'échanger de manière sécurisée avec toutes les administrations. Contrairement à Mattermost, la sécurité des échanges est garantie grâce à du chiffrement de bout en bout **dans les canaux chiffrés**.
