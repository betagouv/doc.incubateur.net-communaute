...
* Pour tout problème ou toute question concernant une des étapes de ton intégration, tu es invité à envoyer un message sur [🔒`#incubateur-secretariat`](https://mattermost.incubateur.net/betagouv/channels/incubateur-secretariat) ou [🔒`#incubateur-help`](https://startups-detat.slack.com/messages/incubateur-help/).
...
[🔒`#incubateur-compta`](https://startups-detat.slack.com/messages/incubateur-compta/) [🔒`#incubateur-indép-octo`](https://startups-detat.slack.com/messages/incubateur-indép-octo/) [🔒`#incubateur-secretariat`](https://mattermost.incubateur.net/betagouv/channels/incubateur-secretariat)
