# Bilan 2025 — beta.gouv.fr

Cette page est une transcription de la présentation qui a été faite début 2026.

[Télécharger le Bilan 2025PDF – 783 KB](https://beta.gouv.fr/content/docs/betagouv_bilan_2025.pdf)
...
L’approche beta.gouv.fr est l’application des pratiques produit et _lean startup_ au sein de lʼÉtat :
...
[Découvrir les incubateurs du réseau](https://beta.gouv.fr/incubateurs)
...
![Graphe complexe montrant la répartition des produits (investigation, construction, accélération, transfert et succès) selon les incubateurs. Tendance principale décrite dans le texte.](<.gitbook/assets/bilan 2025 incubators.png>)

Cartographie des incubateurs et de la répartition des produits
...
* [**Mon Entreprise**](https://beta.gouv.fr/startups/mon-entreprise.html) (sponsorisé par URSSAF) : des assistants et simulateurs pour obtenir des réponses personnalisées aux questions sur la création et la gestion de son entreprise.
* [**Refugiés.info**](https://beta.gouv.fr/startups/refugies.info.html) (Intérieur) : donner de l’information simple et traduite aux personnes réfugiées et à leurs accompagnants.
* [**Démarche Numérique**](https://beta.gouv.fr/startups/demarches-simplifiees.fr.html) (La Suite / DINUM) : la solution pour dématérialiser n’importe quelle démarche administrative en quelques minutes.
* [**Base adresse nationale**](https://beta.gouv.fr/startups/ban.html) (IGN) : référencer l’intégralité des adresses du territoire et les rendre utilisables par tous.
* [**JeVeuxAider.gouv.fr**](https://beta.gouv.fr/startups/jeveuxaider.html) (DJEPVA) : encourager l’engagement bénévole partout en France.
...
* [**Constat d’état sanitaire**](https://beta.gouv.fr/startups/etat-sanitaire-des-monuments-historiques-en-mobilite.html) (Culture) : faciliter et fiabiliser “la veille sanitaire” du contrôle scientifique et technique (CST) sur les monuments historiques.
...
| <p><strong>Produits lancés par la DINUM selon lʼapproche beta.gouv.fr</strong><br><em>(lorsquʼune phase dʼinvestigation confirme le besoin dʼune solution numérique pour résoudre le problème cible, le service numérique est lancé)</em></p>    | 7              | 8                  | **11**         |
| <p><strong>Produits à impact national</strong><br><em>Nombre de produits qui répondent aux critères définis</em></p>                                                                                                                             | 7              | 5                  | **6**          |

Résultats 2025 du Projet de loi de finances
...
[Découvrir tous nos services à impact national](https://beta.gouv.fr/startups/?national_impact=true)
...
**La transparence est un standard au cœur de l’approche beta.gouv.fr**. Les codes sources des services numériques conçus au sein du programme doivent être ouverts, conformément à la Loi pour une République Numérique de 2016, et les services sont tenus de mesurer leur usage et leur impact sur une page _Statistiques_ publique pour justifier la valeur qu’ils apportent à leurs utilisateurs et utilisatrices :
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ----------------------------------------- | ------------------------ |
| [**L'annuaire des entreprises**](https://annuaire-entreprises.data.gouv.fr/) : retrouver toutes les informations concernant les entreprises françaises | <p>- Partenariats technologiques avec des administrations<br>- Partenariats bizdev avec des administrations<br>- Communication<br>- Création d’un véritable parcours d’accès à la donnée restreinte (en production aujourd’hui)</p>                  | 200k €         | 16 000 agents connectés                   | +30 % d’agents connectés |
| [**Faritas**](https://faritas.beta.gouv.fr/) : FAciliter le Recouvrement de l’Impôt et de la TAxe de Séjour                                            | <p>- Intensification du déploiement<br>- Actions de communication à large spectre<br>- Amélioration technique de l’outil pour soutenir le déploiement</p>                                                                                            | 200k €         | 43 M€ de taxes de séjour                  | +126 % de taxes          |
| [**Mes Aides Reno**](https://mesaides.france-renov.gouv.fr/) : simplifier l’accès à l’information sur les aides à la rénovation énergétique            | <p>- Coopération avec l’Anah dans un objectif d’intégration à France Rénov’<br>- Consolidation du trafic et optimisation de la conversion (partenariat France Info, Leboncoin, sites publics)</p>                                                    | 200k €         | 74 000 simulations terminées              | +51 % d’ARSA             |
| [**Dora**](https://dora.inclusion.gouv.fr/) : orienter les usagers vers des solutions pour la levée des freins périphériques à l’emploi                | <p>- Augmentation de la part des utilisateurs (+10% en 1 an)<br>- Améliorer notre activation et notre rétention sur les inscrits (taux de réponse à une demande d’orientation)<br>- Mieux comprendre l’impact (page statistique, funnel repensé)</p> | 200k €         | 6768 mises en relation réalisées par mois | 18 % d’IMER              |
| [**Grist**](https://lasuite.numerique.gouv.fr/produits/grist) : transformer les données en décisions fiables via un tableur collaboratif et souverain  | <p>- Définition du positionnement marketing et de la marque Grist<br>- Activation, rétention et support utilisateur<br>- Amélioration du parcours de découverte de Grist<br>- Création et mise en place d’une stratégie de business development</p>  | 200k €         | 12 210 utilisateurs actifs mensuel        | +72 % d’utilisateurs     |

Lauréats FAST 16

| Produit et enjeux traités                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Métrique phare                                                                                      | Objectifs à 6 mois                                                       |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| <p><a href="https://dialog.beta.gouv.fr/"><strong>Dialog</strong></a> : faciliter l’intégration de la réglementation routière dans les applications de mobilité<br><br>- Changer la promesse d’utilité (camions vs diffusion données, praticité, travaux)<br>- Mieux prendre en compte les arrêtés complexes<br>- Reconstruire et monitorer le funnel de conversion</p>                                                                                                                                                                                                                                                                   | Nombre d’arrêtés publiés et % de métropoles branchées                                               | passer de 1 400 arrêtés à 14 000 et de 1 à 16 métropoles                 |
| <p><a href="https://santepsy.etudiant.gouv.fr/"><strong>Santé Psy Étudiant</strong></a> : permettre aux étudiants de bénéficier de consultations avec des psychologues validés par les services médicaux des universités sans avance de frais.<br>- Créer l’espace étudiant<br>- Intégrer la validation de séances<br>- Note d’utilité</p>                                                                                                                                                                                                                                                                                                | Nombre d’étudiants actifs ayant créé leur espace sur SPE                                            | N/A                                                                      |
| <p><a href="https://lasuite.numerique.gouv.fr/"><strong>LaSuite</strong></a> : réunir les outils du quotidien des agents publics<br>- Notoriété forte sur LaSuite : utiliser cette notoriété pour activer Docs et Visio<br>- S'appuyer sur les champions/ power user pour qu'ils participent à la croissance en devenant des relais</p>                                                                                                                                                                                                                                                                                                   | 50K utilisateurs actifs mensuels pour Visio et 40K pour Docs                                        | N/A                                                                      |
| <p><a href="https://data.inclusion.gouv.fr/"><strong>Data Inclusion</strong></a> : recenser toute l'offre d'insertion sociale et professionnelle de France<br><br>- Relance des sites de consommateurs considérés “pure players” avec un process simplifié et un nouveau schéma de données<br>- Développement d’un widget pour les acteurs hors pure players<br>- Facilitation du versement de nouvelles données pour les petits producteurs locaux</p>                                                                                                                                                                                   | Nombre d’utilisateurs potentiels touchés chaque mois (vs nb de consultations de services jusqu’ici) | Objectif à fixer fin mars 2026                                           |
| <p><a href="https://mon-devis-sans-oublis.beta.gouv.fr/"><strong>Mon Devis Sans Oublis</strong></a> : fluidifier l'instruction des aides en limitant les allers-retours sur les devis lors de l'instruction des dossiers de demandes d'aides à la rénovation énergétique pour les logements<br><br>- Fiabilité<br>- Sales API<br>- Mon devis sans oublis “full email”<br>- Scrapping Email + emailing<br>- SEO Check-list</p>                                                                                                                                                                                                             | Nombre de devis pré-contrôlés                                                                       | 20 000 devis pré-contrôlés (7400 à date - depuis 10 mois)                |
| <p><a href="https://panoramax.fr/"><strong>Panoramax</strong></a> : l’alternative libre pour photo-cartographier les territoires<br><br>- Densifier 5 territoires prioritaires (Lyon, etc.)<br>- Activer les partenariats avec les éditeurs SIG<br>- Outiller pour mesurer et évaluer la consommation</p>                                                                                                                                                                                                                                                                                                                                 | Photos téléversées et consultées                                                                    | 20M nouvelles photos téléversées :et 5M nouvelles photos consultées : 5M |
| <p><a href="https://domifa.fabrique.social.gouv.fr/"><strong>Domifa</strong></a> : faciliter l'accès aux droits pour les personnes sans domicile stable, en simplifiant la gestion de la domiciliation<br><br>- Acquisition : créer du contenu déclinable et lancer des campagnes de communication ciblées aux structures et aux référents territoriaux<br>- Activation : refondre le parcours d’inscription et mettre en place un suivi personnalisé des grandes structures inactives >2k domiciliés<br>- Recommandation - Booster le bouche à oreille via du contenu témoignage et partage de bonnes pratiques entre professionnels</p> | Part des domiciliés actifs accompagnés                                                              | Ambition à 6 mois : passer de 59 % à 68 % de couverture nationale        |
| <p><a href="https://signal-logement.beta.gouv.fr/"><strong>SignalLogement</strong></a> : Accélérer la résolution des situations de mal logement des usagers en accompagnant les territoires<br><br>- Expérimentation “Injonction automatisée”<br>- Embarquer le triptyque Territoire - Locataire - Bailleur</p>                                                                                                                                                                                                                                                                                                                           | Nombre de bailleurs qui apportent une réponse à la démarche accélérée                               | 100 bailleurs répondants                                                 |
...
![Graphique complexe, en barre, de 2015 à 2025, sur le nombre d'arrivées d'agents publics et prestataires. Tendance principale décrite dans le texte.](<.gitbook/assets/bilan 2025 agents.png>)

Nouveaux agents impliqués chaque année dans beta.gouv.fr
...
![Graphique sous forme de courbe d'aires montrant la répartition des domaines d'expertises dans la communauté. Tendance principale décrite dans le texte.](<.gitbook/assets/bilan 2025 metiers.png>)

Répartition des domaines d'expertises dans la communauté
...
![Graphe complexe dont la tendance est indiquée dans le texte.](<.gitbook/assets/bilan 2025 intra.png>)

Durée de la mission des intras au sein de beta.gouv.fr
...
Face à l’intensification du phénomène de retrait-gonflement des argiles, qui fragilise durablement des milliers de logements, la plateforme [Fonds Prévention Argile](https://beta.gouv.fr/startups/fonds-prevention-argile.html) apporte une **réponse structurante à un risque climatique majeur**.
...
En capitalisant sur [Démarches numériques](https://demarche.numerique.gouv.fr/), [Mon Devis Sans Oublis](https://beta.gouv.fr/startups/mon-devis-sans-oublis.html), le [Référentiel national des bâtiments](https://beta.gouv.fr/startups/bat-id.html), [Mes Aides Réno](https://beta.gouv.fr/startups/mesaidesreno.html) et l’écosystème existant, il constitue un exemple remarquable de mutualisation.

**Traiter un enjeu structurel par l’IA**

[Romaric Haldenwang](https://eig.numerique.gouv.fr/personnes/romaric-haldenwang/), directeur technique de [Dossier Facile](https://beta.gouv.fr/startups/dossierfacile.html), a identifié très tôt le potentiel de l’intelligence artificielle. Il a ainsi lancé le service [Document-IA](https://beta.gouv.fr/startups/document-ia.html), **développé en seulement deux mois**, pour passer rapidement de l’intuition à l’expérimentation concrète.
...
En fédérant des services plébiscités comme [Impact CO2](https://beta.gouv.fr/startups/impact.co2.html) et [Nos Gestes Climat](https://beta.gouv.fr/startups/nosgestesclimat.html) et désormais [J’agis](https://beta.gouv.fr/startups/france.nation.verte.agir.html), elle a structuré un véritable **pôle numérique citoyen au sein de l’ADEME**.
...
À la Direction générale de l’administration et de la fonction publique (DGAFP), [Denis Duwoye](https://www.eig.numerique.gouv.fr/personnes/denis-duwoye/) a initié avec le [CSP Lab](https://beta.gouv.fr/startups/csplab.html) un espace dédié à l’expérimentation et à l’innovation dans les politiques de ressources humaines publiques.
...
![Répartition des arrêts par phase (description détaillée disponible ci-après)](<.gitbook/assets/bilan 2025 gonogo.png>)

Répartition des arrêts par phase
...
![Matrice d'impact (description détaillée disponible ci-après)](<.gitbook/assets/bilan 2025 matrice impact.png>)
...
| ---------- | ----------------- | ------------------------------------------------------------------------------------------------------------ | ---------------- |
| Utilisable | Produit           | <p>- Note de facilité d'usage<br>- Taux de contact du support<br>- Taux d'abandon</p>                        | N/A              |
| Utilisé    | Produit           | <p>- Part de marché<br>- Nombre d'utilisateurs actifs<br>- Nombre de transactions<br>- Taux de rétention</p> | Coût à l'utilité |
| Utile      | Produit           | <p>- Valeur générée<br>- Note de satisfaction du service rendu</p>                                           | Coût à l'usage   |
| Impactant  | Politique produit | <p>- Impact mesuré<br>- Risques évités<br>- Autre impacts diffus</p>                                         | Coût à l'impact  |
...
![Graphe complexe de répartition de la durée des phases. Tendance principale décrite dans le texte.](<.gitbook/assets/bilan 2025 duree vie phase.png>)

Répartition de la durée des phases
