...
> 🚩 **L'avis de la communauté** : En cas de doute sur une stratégie, sollicitez un regard extérieur via le canal Tchap [Domaine-bizdev](https://tchap.gouv.fr/#/room/!LYLjHbBZdxMBOORgaJ:agent.dinum.tchap.gouv.fr) pour identifier si le blocage vient de la méthode ou du produit.
...
* **Tchap** canal [Domaine-bizdev](https://tchap.gouv.fr/#/room/!LYLjHbBZdxMBOORgaJ:agent.dinum.tchap.gouv.fr) : entraide et partage d'expérience entre BizDev beta
