...
* [ ] annoncer son lancement sur Tchap dans le canal "Général" de l'espace beta.gouv.fr, avec un lien vers sa fiche produit, ou dans l'infolettre beta.gouv.fr.
...
* [ ] vérifier si des outils no-codes peuvent être mobilisés. La communauté met en particulier un outil de [site vitrine](https://doc.incubateur.net/communaute/les-outils-de-la-communaute/autres-services/sites-faciles) et [un outil de gestion de base de donnée](https://doc.incubateur.net/communaute/les-outils-de-la-communaute/autres/grist).
* [ ] sélectionner son premier ou sa première dev (si besoin de développement) et chargé(e) de déploiement. Ce sont les deux compétences prioritaires en début de construction. Bien demander de l'aide au référent métier ! Tutoriel pour[ renforcer son équipe.](https://doc.incubateur.net/communaute/gerer-son-produit/renforcer-l-equipe)​
