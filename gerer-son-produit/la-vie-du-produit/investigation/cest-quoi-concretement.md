...
Il arrive que des administrations nous demandent une description rapide de l'investigation et des explications courtes de l'accompagnement de beta.gouv.fr.
...
<summary>Ce que n'est pas la méthode d'investigation</summary>

La discussion a été initiée sur le thème « Qu'est-ce qu'on peut répondre à un sponsor qui nous demande si on a une démarche scientifique ? ». Ce texte partage des arguments si vous vous retrouvez dans ce cas de figure. Il ne s'agit donc pas d'une description de la démarche d'investigation.
