...
* Les membres de l'équipe obtiennent **une adresse mail pérenne** (non fournie par [beta.gouv.fr](http://beta.gouv.fr)) après la consolidation.
  * Les alumni restent bienvenus dans les événements de la communauté [beta.gouv.fr](http://beta.gouv.fr) (notamment Forum) et peuvent continuer à avoir un accès à Tchap.
