...
L'impact et sa mesure font partie des [standards.beta.gouv.fr](https://standards.beta.gouv.fr/) à respecter pour utiliser le [marché beta.gouv.fr](../gestion-au-quotidien/marches/marche-interministeriel-beta/).
...
<img width="3200" height="1430" alt="Capture d’écran 2026-03-05 à 14 24 03" src="https://github.com/user-attachments/assets/119bfc26-5b88-487a-8f56-c8898c19998c" />
...
Si vous avez besoin d'aide pour le remplissage de cette matrice, vous pouvez bloquer des créneaux avec un membre de l'équipe coach

* Informations sur la matrice impact : [des prises de rdv courtes (15min) ](https://rdv.anct.gouv.fr/motif/sAcW94iC/informations-sur-la-matrice-impact)sont disponibles pour échanger avec un coach sur des questions de compréhensions
* Accompagnement perfectionnement de la matrice d'impact : [des prises de rdv longues(45min) ](https://demarche.numerique.gouv.fr/commencer/accompagnement-perfectionnement-matrice-impact)seront disponibles pour échanger sur une V1 d’une matrice (formulaire à remplir en amont).

Les créneaux seront disponibles à partir du mercredi 14 janvier 2025.
