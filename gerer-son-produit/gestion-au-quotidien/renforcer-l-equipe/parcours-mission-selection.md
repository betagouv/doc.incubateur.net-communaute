# Parcours "mission sélection"

Besoin de renforcer l’équipe de ta start-up d’État ?
...
* Tu ne maitrises pas les compétences métiers recherchées ;
* Tu passes des heures à trier des candidatures non pertinentes ;
* Tu lis des conseils qui ne sont pas adaptés à ton contexte d’intra dans la fonction publique.
* Tu te sens démuni et tu as peur de te tromper. Mais tu n’a pas le temps d’apprendre sur le tas.
* Tu as besoin d’avancer vite sur des résultats avant le prochain comité d’investissement.
{% endcolumn %}
{% endcolumns %}
...
* Etre capacité d’expliciter facilement ta décision
* Maximiser tes chances de réussir l’embarquement de la personne
...
**1️⃣ Cadrer le besoin de prestation**. Sans cadrage, ça ne sert à rien de se lancer. Le moutons à 5 pattes n’existe pas, il faut pondérer les attentes.

**2️⃣ Rédiger une annonce efficace**. L’annonce est un un aimant qui doit attirer les bons profils et repousser les autres.
...
* Mettre en place un processus de sélection clair, objectif et efficace étape par étape de l’annonce à la proposition contractuelle
* Mener des entretiens structurés et poser les bonnes questions
* Adopter la bonne posture vis-à-vis des candidats
* Contrer les principaux biais psychologique dans la prise de décision
* Savoir dire “_oui_” ou “_non_” avec des critères clairs, en t’appuyant sur des faits
* Attirer et convaincre les meilleurs profils
...
* un atelier collectif en ligne et/ou un module de e-learning à suivre à ton rythme ;
* une mise en pratique pour avancer sur la sélection de ton profil idéal ;
* des échanges entre pairs pour se soutenir et s’entre-aider ;
* le coach RH et les référents métiers répondent à tes questions ;
...
#### 👍 **3 raisons de rejoindre le programme**

* **Clé en main**. Une méthode pas à pas, adaptée au contexte des start-ups d’État. Tu appliques concrètement la méthode, tu construits ton processus de sélection. Étape après étape, tu sélectionnes la personne qui rejoindra ton équipe.
