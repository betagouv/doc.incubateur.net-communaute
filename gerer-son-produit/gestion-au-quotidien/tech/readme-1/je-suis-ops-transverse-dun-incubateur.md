...
* Une fois le ticket choisi, vérifier que personne n'a déjà traité le sujet : parcourez les messages postés sur le canal Tchap [Domaine-Secu](https://tchap.gouv.fr/#/room/!XPllVpJRcpZCaSiaXW:agent.dinum.tchap.gouv.fr?via=agent.dinum.tchap.gouv.fr) depuis la date de la fuite, et vérifiez que personne n'a encore prévenu l'équipe concernée.
...
* Prévenez sur [Domaine-Secu](https://tchap.gouv.fr/#/room/!XPllVpJRcpZCaSiaXW:agent.dinum.tchap.gouv.fr?via=agent.dinum.tchap.gouv.fr) que vous avez informé l'équipe, en précisant la date butoir à laquelle l'équipe doit avoir rempli le feedback.
