---
description: >-
  Cette documentation vise à aider les équipes à réagir si elles sont
  confrontées à des attaques de phishing, typosquatting ou usurpation de
  l'identité de leur produit numérique.
---

# Réagir à une attaque de phishing

{% hint style="danger" %}
Si vous faites face à une attaque, rendez-vous directement en section [Lutte et contre mesures](security-phishing-attack.md#lutte-contre-mesures) !
{% endhint %}
...
* Votre RSSI
* Le [responsable technique de votre incubateur](to-do-liens-avec-les-referents-techs.md)
...
**Articles de loi applicables :** Dans le cas d'une attaque de phishing par typosquatting avec réutilisation de votre code source, voici les articles de loi applicables :
...
L'APIE pourra lancer des actions via leur partenaire technique Nameshield (voir [Mission APIE / Nameshield](security-phishing-attack.md#2-mission-apie--nameshield))
