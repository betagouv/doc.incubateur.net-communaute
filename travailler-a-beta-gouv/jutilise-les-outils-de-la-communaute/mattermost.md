...
* Entrez votre adresse beta pour recevoir l’email de récupération de mot de passe. 
* Cliquez sur le lien contenu dans l’email et configurez votre  mot de passe avec les contraintes suivantes : 
  * 12 - 64 caractères 
 ...
 ****3. Pour faciliter la gestion de l’espace, vous pouvez changer votre “Nom d'utilisateur” par prenom.nom \(comme le début de votre email\). Il vous faut :
...
2.     Un bandeau latéral s’ouvre, écrivez votre message puis cliquez sur « ajouter un commentaire » :
...
3.     Votre réponse apparaît directement dans le canal avec mention que c’est un commentaire et la référence du message d’origine. 
...
1.     Cliquez sur le « + » à côté de « Messages personnels »
...
2.     Ajoutez autant de personnes que nécessaires
...
Tous les canaux présents sur Slack vont être ou ont été transférés sur l’espace Mattermost. Pour créer un nouveau canal :
...
3.     Déplacez des canaux dans vos différentes catégories en « glissé-déposé ». 
