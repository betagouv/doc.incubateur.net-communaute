...
3. Tu reçois un email de bienvenue dans ta boite email personnel qui te permet d'activer ton email @beta.gouv.fr (le temps de faire passer les tests, cela peut prendre 1/2 après l'étape précédente) ;
