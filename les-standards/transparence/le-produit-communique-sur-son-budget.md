...
La bonne tenue et publication de votre budget assure la transparence financière et l'engagement des parties prenantes autour de votre produit.
...
2. Elle apporte une contribution essentielle à la communauté en permettant aux nouveaux services d'avoir une vision éclairée de la façon dont se structure un budget et les ressources à mobiliser en fonction des ambitions
3. Elle fournit un outil essentiel de comparaison de coûts et de sécurisation budgétaire entre les services de beta.gouv.fr et les projets système d'informations (SI) de l'État. En effet, le référentiel du modèle budgétaire a été travaillé en commun avec les différentes directions du numérique (DNUM). Il a donc vocation à être utilisé par les services de l'écosystème mais également par les projets numériques ayant recours au marché Beta ainsi que par les projets numériques ne travaillant pas en mode produit agile à impact.
...
1. en janvier où le montant réellement dépensé de l'année N-1 est mis à jour et où le montant prévisionnel de l'année N est projeté
