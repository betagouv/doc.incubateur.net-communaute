...
Lorsqu'un service numérique fait partie du réseau beta.gouv.fr, nous nous attendons à un haut niveau de qualité et d'excellence, prouvant que le service public est capable de produire du numérique à l'état de l'art. beta.gouv.fr a donc pour objectif de créer des services publics numériques :
