...
Chaque équipe est autonome, pluridisciplinaire et **regroupe des agents publics qui passent des commandes de prestation via les marchés publics et ainsi travaillent avec des personnes issues du secteur privé missionnées pour assurer ces prestations**. Le but est à chaque fois de réunir les meilleures personnes pour s'attaquer à un problème de politique publique et construire un service qui facilite la vie de ses utilisateurs, améliore les conditions de travail des agents publics ou augmente l'efficacité de nos politiques publiques.
