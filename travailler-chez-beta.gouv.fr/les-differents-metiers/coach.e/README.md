...
## Quel est le rôle d'un·e coach ?

Chez [beta.gouv.fr](http://beta.gouv.fr), les coachs sont chargés de mettre en place les conditions nécessaires pour que les services accompagnés puissent démontrer un impact concret et mesurable sur les usagers et les politiques publiques au sein desquelles ils s’inscrivent. Pour créer ces conditions, les coachs ont les missions suivantes :
...
* Partager leurs expertises sur l’accompagnement de services numériques :
  * s’assurer que l’équipe est focalisée sur l’impact sur les usagers et la politique publique ;
  * Aider l’équipe à choisir les bons outils et méthodes pour atteindre ses objectifs.
...
## **Postures et redevabilités des coachs**&#x20;

Les coachs **doivent faire avec** et **apprendre aux personnes accompagnées à faire** et non faire à leur place.

**Les coachs doivent adopter une posture adéquate pour faire monter en compétences les agents publics intrapreneurs ou experts métiers.**

Les coachs sont membres des équipes à part entière mais redevables auprès des responsables de d'incubateur et/ou des responsables de partenariat de la DINUM. Ces derniers attendent des coachs qu'ils·elles :
...
## Durée et niveau d'intervention des coachs&#x20;

#### Durée d'une mission

Les coachs doivent devenir dispensables. Ils·elles n’ont pas vocation à endosser un rôle opérationnel dans les équipes dans la durée. Au contraire, ils·elles doivent aider à prioriser les recrutements et autonomiser l’équipe pour que leur implication diminue progressivement. **C’est également la responsabilité du coach que de s’interroger régulièrement sur le fait de savoir si il**·**elle est la bonne personne.**
...
⚠️ Si un·e coach dépasse les 2 ans de mission sur un même produit, sa mission doit être stoppée (hors cas particulier, comme l'absence d'intrapreneur·e ou le besoin impérieux de continuité de service). Il peut ensuite être remplacé par un·e autre coach.

#### **Niveau d'intervention**

Voici les usages en terme d'engagement pour un·e coach en fonction de la phase de la startup d'État :

<table><thead><tr><th>Phase</th><th width="149">Nombre de jours maximum sur la période</th><th>Nombre de jours moyen par semaine (avec lissage des variations)</th><th width="155.140625">Implication</th><th>But</th></tr></thead><tbody><tr><td><a href="../../../gerer-son-produit/la-vie-du-produit/investigation/">Investigation</a></td><td>20 jours sur 9 semaines</td><td>2 jours</td><td>Régulière</td><td>Accompagner l'intrapreneur·e pour le rendre autonome</td></tr><tr><td><a href="../../../gerer-son-produit/la-vie-du-produit/construction/">Construction</a></td><td><ul><li>40 jours sur les 6 premiers mois de construction</li><li>25 jours sur 6 mois après les 6 premiers mois de construction</li></ul></td><td><p></p><ul><li>2 jours par semaine sur les 6 premiers mois de construction</li><li>1 jours par semaine sur 6 mois après les 6 premiers mois de construction</li></ul></td><td><ul><li>Régulière</li><li>Décroissante</li></ul></td><td>Accompagner la création d'une équipe et son autonomisation</td></tr><tr><td><a href="../../../gerer-son-produit/la-vie-du-produit/acceleration/">Accélération</a></td><td><p>25 jours</p><p>sur 6 mois</p></td><td>1 jour</td><td>Décroissante</td><td>Accompagner l'équipe pour l'aider à accélérer</td></tr><tr><td><a href="../../../gerer-son-produit/la-vie-du-produit/perennisation/">Pérennisation</a></td><td><p>15 jours</p><p>sur 6 mois</p></td><td>1 jour</td><td>Régulière</td><td>Accompagner l'équipe et l'administration d'accueil</td></tr></tbody></table>

Une implication régulière signifie que le·la coach sera présent de façon continue tout au long de la mission.

Une implication décroissante signifie que le·la coach sera de moins en moins présent tout au long de la mission.
...
**Au delà de cet unique jour facturé par semaine, il ne s'agit plus d'une mission de coaching**. Cela signifie que le·la coach intervient plutôt sur une mission de product management, déploiement, ou autre. Cette pratique est autorisée. En revanche le montant facturé pour les jours travaillés doit être adapté à la mission (voir [l'observatoire des revenus](https://doc.incubateur.net/communaute/travailler-chez-beta.gouv.fr/les-differents-statuts/independants-freelances/observatoire-revenus#la-grille-indicative-des-tjm-observes)).
...
Un échange entre le·la coach, l'intra et le·la responsable de portefeuille permet de définir le niveau d'intervention adaptée à la mission au regard du contexte, des attentes et des compétences de chacun.
...
Le cahier des charges du **marché interministériel de mentorat** (2024 - 2028) définit les attentes vis à vis des coachs (ou mentors) en termes de livrables :&#x20;
