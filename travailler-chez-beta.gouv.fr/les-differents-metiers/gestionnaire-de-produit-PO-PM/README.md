# Gestionnaire de produit (PO/PM)

{% hint style="info" %}
Les **gestionnaires de produit** (_Product Manager_ ou responsable produit) pilotent ou copilotent (avec l'[intrapreneur](broken-reference)) le service numérique.
{% endhint %}
