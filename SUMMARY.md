...
* [✅ Les standards](les-standards/README-doc-incubateur-net.md)
  ...
  * [✅ Sécurité](les-standards/sécurité/README.md)
    * [L'équipe a entamé une démarche d'homologation de sécurité](les-standards/sécurité/l-equipe-a-entame-une-demarche-d-homologation-de-securite.md)
    * [L'équipe a mis en place un outil d'analyse statique du code](les-standards/sécurité/l-equipe-a-mis-en-place-un-outil-d-analyse-statique-du-code.md)
    * [L'équipe organise régulièrement des ateliers d'analyse de risque](les-standards/sécurité/l-equipe-organise-regulierement-des-ateliers-d-analyse-de-risque.md)
